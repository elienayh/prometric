...
//#region node_modules/jsqr/dist/jsQR.js
var require_jsQR = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function(modules) {
			...
			(function(module$4, exports$3, __webpack_require__) {
				...
				exports$3.addOrSubtractGF = addOrSubtractGF;
				exports$3.default = function() {
					function GenericGF(primitive, size, genBase) {
						...
						for (var i = 0; i < this.size; i++) {
							this.expTable[i] = x;
							x = x * 2;
							if (x >= this.size) x = (x ^ this.primitive) & this.size - 1;
						}
			...
			(function(module$5, exports$4, __webpack_require__) {
				...
				exports$4.default = function() {
					...
					GenericGFPoly.prototype.addOrSubtract = function(other) {
						...
						if (smallerCoefficients.length > largerCoefficients.length) _a = [largerCoefficients, smallerCoefficients], smallerCoefficients = _a[0], largerCoefficients = _a[1];
			...
			(function(module$7, exports$6, __webpack_require__) {
				...
				function binarize(data, width, height, returnInverted) {
					...
					for (var x = 0; x < width; x++) for (var y = 0; y < height; y++) {
						...
						greyscalePixels.set(x, y, .2126 * r + .7152 * g + .0722 * b);
					}
			...
			(function(module$8, exports$7, __webpack_require__) {
				...
				function decodeMatrix(matrix) {
					...
					var dataBlocks = getDataBlocks(readCodewords(matrix, version, formatInfo), version, formatInfo.errorCorrectionLevel);
				...
				function decode(matrix) {
					...
					for (var x = 0; x < matrix.width; x++) for (var y = x + 1; y < matrix.height; y++) if (matrix.get(x, y) !== matrix.get(y, x)) {
						matrix.set(x, y, !matrix.get(x, y));
						matrix.set(y, x, !matrix.get(y, x));
					}
					return decodeMatrix(matrix);
				}
				exports$7.decode = decode;
			}),
			(function(module$9, exports$8, __webpack_require__) {
				...
				(function(Mode) {
					...
					Mode["Kanji"] = "kanji";
					Mode["ECI"] = "eci";
				})(Mode = exports$8.Mode || (exports$8.Mode = {}));
				var ModeByte;
				(function(ModeByte) {
				...
				function decodeNumeric(stream, size) {
					...
					while (length >= 3) {
						...
						if (num >= 1e3) throw new Error("Invalid numeric value above 999");
				...
				function decode(data, version) {
					...
					while (stream.available() >= 4) {
						...
						else if (mode === ModeByte.ECI) if (stream.readBits(1) === 0) result.chunks.push({
							type: Mode.ECI,
			...
			(function(module$11, exports$10, __webpack_require__) {
				"use strict";
				Object.defineProperty(exports$10, "__esModule", { value: true });
				exports$10.shiftJISTable = {
					32: 32,
					33: 33,
					34: 34,
					35: 35,
			...
			(function(module$12, exports$11, __webpack_require__) {
				"use strict";
				...
				function runEuclideanAlgorithm(field, a, b, R) {
					var _a;
					if (a.degree() < b.degree()) _a = [b, a], a = _a[0], b = _a[1];
					var rLast = a;
					var r = b;
				...
				exports$11.decode = decode;
			}),
			(function(module$13, exports$12, __webpack_require__) {
				"use strict";
			...
			(function(module$14, exports$13, __webpack_require__) {
				...
				function extract(image, location) {
					...
					var transform = times(squareToQuadrilateral(location.topLeft, location.topRight, location.alignmentPattern, location.bottomLeft), qToS);
					...
					for (var y = 0; y < location.dimension; y++) for (var x = 0; x < location.dimension; x++) {
						var sourcePixel = mappingFunction(x + .5, y + .5);
				...
				exports$13.extract = extract;
			}),
			(function(module$15, exports$14, __webpack_require__) {
				"use strict";
				Object.defineProperty(exports$14, "__esModule", { value: true });
				var MAX_FINDERPATTERNS_TO_SEARCH = 4;
				var MIN_QUAD_RATIO = .5;
				...
				function scorePattern(point, ratios, matrix) {
					try {
						...
						var topLeftBottomRightRun = countBlackWhiteRun(point, {
							x: Math.max(0, point.x - point.y) - 1,
							y: Math.max(0, point.y - point.x) - 1
						}, matrix, ratios.length);
						var bottomLeftTopRightRun = countBlackWhiteRun(point, {
