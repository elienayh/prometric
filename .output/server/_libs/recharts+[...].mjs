...
var hasClipDot = function hasClipDot(dot) {
	return dot && _typeof$44(dot) === "object" && "clipDot" in dot;
};
/**
		...
		},
		{
			...
			value: function renderItems() {
				...
				return payload.map(function(entry, i) {
					...
					var className = clsx(_defineProperty$41(_defineProperty$41({ "recharts-legend-item": true }, "legend-item-".concat(i), true), "inactive", entry.inactive));
...
_defineProperty$41(DefaultLegendContent, "displayName", "Legend");
_defineProperty$41(DefaultLegendContent, "defaultProps", {
	iconSize: 14,
	layout: "horizontal",
	align: "center",
	verticalAlign: "middle",
...
var Legend = /*#__PURE__*/ function(_PureComponent) {
	function Legend() {
		...
		_defineProperty$40(_this, "lastBoundingBox", {
			width: -1,
			height: -1
		});
		return _this;
...
_defineProperty$40(Legend, "displayName", "Legend");
_defineProperty$40(Legend, "defaultProps", {
	iconSize: 14,
	layout: "horizontal",
	align: "center",
...
function getTooltipCSSClassName(_ref) {
	...
	return clsx(CSS_CLASS_PREFIX, _defineProperty$38(_defineProperty$38(_defineProperty$38(_defineProperty$38({}, "".concat(CSS_CLASS_PREFIX, "-right"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX >= coordinate.x), "".concat(CSS_CLASS_PREFIX, "-left"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX < coordinate.x), "".concat(CSS_CLASS_PREFIX, "-bottom"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY >= coordinate.y), "".concat(CSS_CLASS_PREFIX, "-top"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY < coordinate.y));
}
...
var TooltipBoundingBox = /*#__PURE__*/ function(_PureComponent) {
	function TooltipBoundingBox() {
		...
		_defineProperty$37(_this, "state", {
			dismissed: false,
		...
		_defineProperty$37(_this, "handleKeyDown", function(event) {
			if (event.key === "Escape") {
...
_defineProperty$36(Tooltip, "displayName", "Tooltip");
_defineProperty$36(Tooltip, "defaultProps", {
...
var appendOffsetOfLegend = function appendOffsetOfLegend(offset, _unused, props, legendBox) {
	...
	if (legendProps) {
		...
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$28(_objectSpread$28({}, offset), {}, _defineProperty$31({}, align, offset[align] + (boxWidth || 0)));
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$28(_objectSpread$28({}, offset), {}, _defineProperty$31({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
	}
	return offset;
};
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId(data, _items, numericAxisId, cateAxisId, offsetType, reverseStackOrder) {
	...
	var stackGroups = (reverseStackOrder ? _items.reverse() : _items).reduce(function(result, item) {
		...
		return _objectSpread$28(_objectSpread$28({}, result), {}, _defineProperty$31({}, axisId, parentGroup));
	}, {});
	return Object.keys(stackGroups).reduce(function(result, axisId) {
		var group = stackGroups[axisId];
		if (group.hasStack) group.stackGroups = Object.keys(group.stackGroups).reduce(function(res, stackId) {
			var g = group.stackGroups[stackId];
			return _objectSpread$28(_objectSpread$28({}, res), {}, _defineProperty$31({}, stackId, {
				numericAxisId,
				cateAxisId,
				items: g.items,
		...
		return _objectSpread$28(_objectSpread$28({}, result), {}, _defineProperty$31({}, axisId, group));
	}, {});
};
/**
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return Object.keys(axisMap).reduce(function(result, id) {
		...
		return _objectSpread$27(_objectSpread$27({}, result), {}, _defineProperty$30({}, id, finalAxis));
	}, {});
};
...
var Polygon = function Polygon(props) {
	var points = props.points, className = props.className, baseLinePoints = props.baseLinePoints, connectNulls = props.connectNulls, others = _objectWithoutProperties$11(props, _excluded$11);
...
var Cross = function Cross(_ref) {
	var _ref$x = _ref.x, x = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$10(_ref, _excluded$10);
...
var PolarAngles = function PolarAngles(props) {
	...
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid-angle" }, polarAngles.map(function(entry) {
		...
		return /*#__PURE__*/ import_react.createElement("line", _extends$17({}, polarAnglesProps, {
...
var ConcentricCircle = function ConcentricCircle(props) {
	...
	return /*#__PURE__*/ import_react.createElement("circle", _extends$17({}, concentricCircleProps, {
...
var ConcentricPolygon = function ConcentricPolygon(props) {
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$17({}, concentricPolygonProps, {
...
var ConcentricPath = function ConcentricPath(props) {
	...
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid-concentric" }, polarRadius.map(function(entry, i) {
		var key = i;
		if (gridType === "circle") return /*#__PURE__*/ import_react.createElement(ConcentricCircle, _extends$17({ key }, props, {
			radius: entry,
			index: i
		}));
		return /*#__PURE__*/ import_react.createElement(ConcentricPolygon, _extends$17({ key }, props, {
			radius: entry,
			index: i
		}));
	}));
...
var PolarGrid = function PolarGrid(_ref) {
	var _ref$cx = _ref.cx, cx = _ref$cx === void 0 ? 0 : _ref$cx, _ref$cy = _ref.cy, cy = _ref$cy === void 0 ? 0 : _ref$cy, _ref$innerRadius = _ref.innerRadius, innerRadius = _ref$innerRadius === void 0 ? 0 : _ref$innerRadius, _ref$outerRadius = _ref.outerRadius, outerRadius = _ref$outerRadius === void 0 ? 0 : _ref$outerRadius, _ref$gridType = _ref.gridType, gridType = _ref$gridType === void 0 ? "polygon" : _ref$gridType, _ref$radialLines = _ref.radialLines, radialLines = _ref$radialLines === void 0 ? true : _ref$radialLines, props = _objectWithoutProperties$9(_ref, _excluded$9);
	if (outerRadius <= 0) return null;
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid" }, /*#__PURE__*/ import_react.createElement(PolarAngles, _extends$17({
		cx,
		cy,
		innerRadius,
		outerRadius,
		gridType,
		radialLines
	}, props)), /*#__PURE__*/ import_react.createElement(ConcentricPath, _extends$17({
		cx,
		cy,
		innerRadius,
		outerRadius,
...
var Radar = /*#__PURE__*/ function(_PureComponent) {
	function Radar() {
		var _this;
		_classCallCheck$12(this, Radar);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$10(this, Radar, [].concat(args));
	...
	_inherits$10(Radar, _PureComponent);
	return _createClass$12(Radar, [
		{
			key: "renderDots",
			value: function renderDots(points) {
				...
				var dots = points.map(function(entry, i) {
					var dotProps = _objectSpread$14(_objectSpread$14(_objectSpread$14({
						key: "dot-".concat(i),
						r: 3
		...
		},
		{
			...
			value: function renderPolygonStatically(points) {
				...
				var radar;
				if (/*#__PURE__*/ import_react.isValidElement(shape)) radar = /*#__PURE__*/ import_react.cloneElement(shape, _objectSpread$14(_objectSpread$14({}, this.props), {}, { points }));
				else if ((0, import_isFunction.default)(shape)) radar = shape(_objectSpread$14(_objectSpread$14({}, this.props), {}, { points }));
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					var stepData = points.map(function(entry, index) {
						...
						if (prev) {
							...
							return _objectSpread$14(_objectSpread$14({}, entry), {}, {
								x: _interpolatorX(t),
								y: _interpolatorY(t)
							});
						}
...
_defineProperty$17(Radar, "getComposedData", function(_ref2) {
	...
	displayedData.forEach(function(entry, i) {
		...
		points.push(_objectSpread$14(_objectSpread$14({}, polarToCartesian(cx, cy, radius, angle)), {}, {
			name,
			value,
			cx,
			cy,
	...
	if (isRange) points.forEach(function(point) {
		if (Array.isArray(point.value)) {
			...
			baseLinePoints.push(_objectSpread$14(_objectSpread$14({}, point), {}, { radius }, polarToCartesian(cx, cy, radius, point.angle)));
...
//#endregion
export { ResponsiveContainer as _, YAxis as a, CartesianGrid as c, Radar as d, Pie as f, Cell as g, PolarGrid as h, LineChart as i, ReferenceArea as l, PolarRadiusAxis as m, PieChart as n, XAxis as o, PolarAngleAxis as p, BarChart as r, Line as s, RadarChart as t, Bar as u, Tooltip as v, Legend as y };
