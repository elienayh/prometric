...
import { c as situationSentence, d as zoneToSituation, i as EXPECTED_ZONES_LABEL, o as REFERENCE_LABEL, r as EXPECTED_INDEX_RANGE, s as scoreToSituation, t as EXPECTED_BAR_RANGE, u as zoneToBarPosition } from "./prometric-reference-G7AL_tS3.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/portal.aluno._token-C4U38pEu.js
...
*/
function ReferenceBar({ zone, value, unit, expectedRange, caption, className, compact = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: SEGMENTS.map((seg, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					pos != null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "absolute top-1/2 z-10 -translate-x-1/2 -translate-y-1/2",
						style: { left: `${pos}%` },
						"aria-label": `Posição do aluno: ${situation ?? "sem classificação"}`,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-5 w-5 rounded-full border-2 border-background bg-foreground shadow-[0_0_0_2px_hsl(var(--foreground))] dark:bg-background dark:shadow-[0_0_0_2px_hsl(var(--background))]" })
					})
				]
			}),
			!compact && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Prioritário" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Atenção" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "font-semibold text-[#16a34a]",
						children: "Referência ProMetric®"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Bom" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Excelente" })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [value != null && value !== "" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SituationBadge, { situation })]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: expectedRange ? `${expectedRange.min}–${expectedRange.max}${unit ? ` ${unit}` : ""}` : EXPECTED_ZONES_LABEL
						})
					]
				})]
			}),
...
var generatePortalReport = createServerFn({ method: "POST" }).inputValidator((d) => {
	...
	return d;
}).handler(createSsrRpc("c6337408bf63234de14ec66bd18b954055367b20153a1222bc755a49b42cc811"));
var $$splitComponentImporter = () => import("./portal.aluno._token-LOZbm6hs.mjs");
var Route = createFileRoute("/portal/aluno/$token")({
...
//#endregion
export { generatePortalReport as i, ReferenceBar as n, Route as r, PortalAluno as t };
